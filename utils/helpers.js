...
export const parseApiError = (error, field) => {
  if (!error?.message) {
    return;
  }
...
export const getImageFormatFromUrl = (url) => {
...
export const getHourWithTimeZone = (value) => {
  if (!value) {
    return '';
  }
...
export const getFlexByRatio = (value) => {
  switch (value) {
    case 0.8:
      return 5;
    case 0.2:
